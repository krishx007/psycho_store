...
<body background=<?php echo site_url('images/bg.jpg')?>>
...
<div class="container top-bottom-space">
	...
	<div class="well row">
		<div class="col-md-12">
			<h3 class="play"><small>We believe that </small> Gamers <small> of this country needs better class of </small>clothing for the Gamer<small> inside them. Rest assured we are upto the task of designing unique clothing inspired by our</small> favorite Video games .</h3>
		</div>
		...
		<div class="col-md-12 text-center">
			<h4 class="molot">Spread the Psychoness</h4>
	...
	<hr>
	<h5 class=""><i class="fa fa-angle-left"></i> <i class="fa fa-angle-right"></i> by Codinpsycho <span class='pull-right'>Psycho Store 2014 &copy; All rights reserved!. Product of Psycho Corporation</span><h5>
</div>
