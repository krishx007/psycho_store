    <footer>      
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-12">
            <hr>
            <h5><i class="fa fa-angle-left"></i> <i class="fa fa-angle-right"></i> by Codinpsycho <span class='pull-right'>Psycho Store 2014 &copy; All rights reserved. Product of Psychonet Solutions Opc Pvt. Ltd.</span><h5>
